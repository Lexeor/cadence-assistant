...
function Metronome() {
    ...
    const sign = () => {
        if(isMuted || volume === 0) {
            ...
            return <>
                <path fill="rgba(255,255,255,.2)" d="M 19.406 20.134 L 17.99 18.718 C 19.907 17.011 21.003 14.566 21 12 C 21.003 9.298 19.789 6.739 17.696 5.032 L 19.116 3.612 C 21.582 5.699 23.003 8.768 23 12 C 23 15.223 21.614 18.122 19.406 20.134 Z M 15.863 16.591 L 14.441 15.169 C 15.425 14.412 16.001 13.241 16 12 C 16 10.57 15.25 9.315 14.12 8.608 L 15.559 7.169 C 17.095 8.299 18.002 10.092 18 12 C 18 13.842 17.17 15.49 15.863 16.591 Z"></path>
                <path d="M 15.877 16.6 L 14.455 15.178 C 15.439 14.421 16.015 13.25 16.014 12.009 C 16.014 10.579 15.264 9.324 14.134 8.617 L 15.573 7.178 C 17.109 8.308 18.016 10.102 18.014 12.009 C 18.014 13.851 17.184 15.499 15.877 16.6 Z"></path>;
                </>
        } else {
